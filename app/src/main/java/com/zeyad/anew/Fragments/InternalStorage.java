...
import com.zeyad.anew.databinding.FragmentInternalStroageBinding;
...
public class InternalStorage extends Fragment implements onFileClickListner, onOptionClicked {

    FragmentInternalStroageBinding binding;
    File storage;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        inflater.inflate(R.layout.fragment_internal_stroage, container, false);
        binding = FragmentInternalStroageBinding.inflate(inflater);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        subPath = InternalStorageArgs.fromBundle(requireArguments()).getPath();
        ...
        binding.storageInformation.setText(information);
        ...
        if (internal_storage_all_files != null) {
            ...
            for (File test : internal_storage_all_files) {
                if (test.getName().toLowerCase().endsWith(".jpg") || test.getName().toLowerCase().endsWith(".jpeg")
                        ...
                        || test.getName().toLowerCase().endsWith(".zip") || test.getName().toLowerCase().endsWith(".docx")
                        || test.getName().toLowerCase().endsWith(".ppt") || test.getName().toLowerCase().endsWith(".xls")) {
